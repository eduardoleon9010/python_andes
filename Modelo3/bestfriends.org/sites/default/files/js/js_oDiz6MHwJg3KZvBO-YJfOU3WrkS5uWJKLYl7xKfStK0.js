...
(function (Drupal, drupalSettings, drupalTranslations, console, Proxy, Reflect) {
  ...
  Drupal.url.isLocal = function (url) {
    ...
    if (protocol === 'http:' && absoluteUrl.indexOf('https://bestfriends.org/new-york-city') === 0) {
      protocol = 'https://bestfriends.org/new-york-city';
    }
...
;
!function(t,o){"use strict";t.behaviors.photoboxInit={attach:function(t){o(".photobox-gallery",t).once("photoboxInit").photobox(".gallery-entry")}},t.behaviors.galleryAlign={attach:function(t){o(".photobox-gallery",t).once("galleryAlign").each(function(){var t=o(this);t.ready(function(){4<t.find(".gallery-entry").length&&t.addClass("alignLeft")})})}}}(Drupal,jQuery,drupalSettings);;

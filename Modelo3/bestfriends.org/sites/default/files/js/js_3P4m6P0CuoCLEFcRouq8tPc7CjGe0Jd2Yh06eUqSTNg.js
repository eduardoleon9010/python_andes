...
(function (Drupal, drupalSettings, drupalTranslations, console, Proxy, Reflect) {
  ...
  Drupal.url.isLocal = function (url) {
    ...
    if (protocol === 'http:' && absoluteUrl.indexOf('https://bestfriends.org/donate/become-member/guardian-angel?utm_campaign=sustainerrecruitmentfeb23') === 0) {
      protocol = 'https://bestfriends.org/donate/become-member/guardian-angel?utm_campaign=sustainerrecruitmentfeb23';
    }
  ...
  Drupal.behaviors.googleCSECustomSearch = {
    attach: function (context, settings) {
      ...
      var getWatermarkBackground = function (value) {
        ...
        var googleCSEImageUrl = 'https://bestfriends.org/donate/become-member/images/google_custom_search_watermark.gif';

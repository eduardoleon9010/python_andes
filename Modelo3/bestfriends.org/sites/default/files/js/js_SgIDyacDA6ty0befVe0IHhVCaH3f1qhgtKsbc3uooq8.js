...
(function (Drupal, drupalSettings, drupalTranslations, console, Proxy, Reflect) {
  ...
  Drupal.url.isLocal = function (url) {
    ...
    if (protocol === 'http:' && absoluteUrl.indexOf('https://bestfriends.org/sanctuary/explore-sanctuary/dogtown/series') === 0) {
      protocol = 'https://bestfriends.org/sanctuary/explore-sanctuary/dogtown/series';
    }
  ...
  Drupal.behaviors.googleCSECustomSearch = {
    attach: function (context, settings) {
      ...
      var getWatermarkBackground = function (value) {
        ...
        var googleCSEImageUrl = 'https://bestfriends.org/sanctuary/explore-sanctuary/dogtown/images/google_custom_search_watermark.gif';

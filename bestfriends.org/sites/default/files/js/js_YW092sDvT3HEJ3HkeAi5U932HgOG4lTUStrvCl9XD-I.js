...
(function (Drupal, drupalSettings, drupalTranslations, console, Proxy, Reflect) {
  ...
  Drupal.url.isLocal = function (url) {
    ...
    if (protocol === 'http:' && absoluteUrl.indexOf('https://bestfriends.org/who-we-are/awards') === 0) {
      protocol = 'https://bestfriends.org/who-we-are/awards';
    }
  ...
  Drupal.behaviors.googleCSECustomSearch = {
    attach: function (context, settings) {
      ...
      var getWatermarkBackground = function (value) {
        ...
        var googleCSEImageUrl = 'https://bestfriends.org/who-we-are/images/google_custom_search_watermark.gif';

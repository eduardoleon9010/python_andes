...
jQuery(function(e){e(".tile-banner-head").ready(function(){e(window).width()<=960&&e(".tile-banner-head").css("font-size",function(){var t=((element=document.getElementById("tilehead")).textContent||element.innerText).split(" ");let n=0;for(let e=0;e<t.length;e++)t[e].length>n&&(n=t[e].length);return 14<=n?"11vw":13<=n?"12vw":12<=n?"13vw":11<=n?"14vw":10<=n?"15vw":9<=n?"16vw":void 0})})});;
...
jQuery(function(e){function t(){e(".hero-primary .heroHeadline").css("font-size",function(){var t=e(this).text().length;if(!(1<=t&&t<65))return 65<=t&&t<120?"4vw":120<=t&&t<140?"3.6vw":"3vw"}),e(".hero-primary .heroContent .heroBody").css("font-size",function(){var t=e(this).text().length;return 1<=t&&t<60?"2.2vw":60<=t&&t<100?"2.0vw":100<=t&&t<140?"1.8vw":"1.6vw"}),e(".hero-primary").addClass("styled-fsz")}e(".hero-primary").ready(function(){960<=e(window).width()&&t()})}),function(n){"use strict";Drupal.behaviors.heroModal={attach:function(t,e){n(".hpCta").click(function(t){n(this).next(".hpCtaModal").length&&(t.preventDefault(),n(this).next(".hpCtaModal").css("display","block"))}),n(".close").click(function(t){n(".hpCtaModal").length&&(t.preventDefault(),n(".hpCtaModal").css("display","none"))})}}}(jQuery);;
  ...
  Drupal.behaviors.googleCSECustomSearch = {
    attach: function (context, settings) {
      ...
      var getWatermarkBackground = function (value) {
        ...
        var googleCSEImageUrl = 'images/google_custom_search_watermark.html';

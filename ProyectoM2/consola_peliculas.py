...
def ejecutar_encontrar_pelicula_mas_larga(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    print('La pelicula mas larga es', pelicula_mas_larga['nombre'], 'con', pelicula_mas_larga['duracion'], 'minutos de duracion')
...
def ejecutar_consultar_duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    print('La duracion promedio de las peliculas en horas y minutos es igual a', duracion_promedio)
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    print('Las peliculas estrenadas en una fecha posterior a esta son:', estrenos + '.')
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    cuantas_mas_dieciocho = mod.cuantas_peliculas_18_mas(p1, p2, p3, p4, p5)
    print("Hay", cuantas_mas_dieciocho, 'peliculas con clasificacion +18')
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        nueva_hora = int(input('Ingrese el nuevo horario para la pelicula: '))
        nuevo_dia = input('Ingrese el nuevo dia para la pelicula (Lunes, Martes, Miércoles, Jueves, Viernes, Sábado, Domingo): ' )
        control = input("Ingrese 'Si' si desea tenga en cuenta sus preferencias sobre el horario o 'No' de lo contrario: ")
        ...
        reagendar = mod.reagendar_pelicula(pelicula, nueva_hora, nuevo_dia, control_horario, p1, p2, p3, p4, p5)
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        puede_invitar = True
        edad_invitado = int(input('Por favor ingrese la edad del invitado: '))
        
        if edad_invitado < 18:
            
            autorizacion = input("Ingrese 'Si' si el invitado tiene permiso de sus padres o 'No' de lo contrario: ")
